...
public class LoginWithDataDriven3 {
@Test(dataProvider = "getMyData4")
  ...
  @DataProvider
  Object[][] getMyData4() throws IOException {
      //1.read the file
      FileInputStream fis=new FileInputStream("Data/MyData4.xlsx");
